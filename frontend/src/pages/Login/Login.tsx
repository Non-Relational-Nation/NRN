...
function Login() {
  return (
    <main className="login-container">
      ...
      <section className="background-decoration">
        <section className="decoration-circle circle-1"></section>
        <section className="decoration-circle circle-2"></section>
        <section className="decoration-circle circle-3"></section>
      </section>
    </main>
  );
}
